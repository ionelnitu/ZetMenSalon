...
closeLightbox(): void {
  ...
  accomplishments: Accomplishment[] = [
    ...
    },
    {
      ...
      image: ['assets/9thCertificate.jpeg'],
      year: '4th May 2026',
      title: 'Fade Academy',
      desc: 'Seminarul 1 to 1 cu Maestrul Ciprian Ungureanu în cadrul Fade Academy. Unul dintre cei mai apreciați profesioniști din industrie pe plan național și internațional. A fost o experiență din care am înțeles că fiecare detaliu contează și fiecare zi e un nou început din care trebuie să obținem maximul. Atmosfera creată în jurul lui Ciprian nu „apasă”, ci te lasă liber. Iar fiecare pas pe care îl faci are sens și claritate, ajutându-te să depășești orice limită. Educația este singurul instrument prin care poți fi sigur că mergi în direcția corectă.',
    },
  ];
